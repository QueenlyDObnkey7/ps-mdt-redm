...
Config.InventoryForWeaponsImages = "rsg-inventory"
...
-- This is a workaround solution because the qb-menu present in qb-vallawjob fills in an impound location and sends it to the event. 
-- If the impound locations are modified in qb-vallawjob, the changes must also be implemented here to ensure consistency.
